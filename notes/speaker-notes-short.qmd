...
Wie man KI-Anwendungen so gestaltet, dass sie diese Strategien unterstützen statt untergraben, behandeln wir übrigens im Intermediate-Kurs.
...
Falls Sie sich fragen, warum das so ist: Im Beginner-Kurs erklären wir die Funktionsweise von Sprachmodellen und ihre Limitationen, was diesen Unterschied verständlicher macht.
...
Das ist nicht KI-Feindlichkeit. Das ist eine kognitionspsychologische Tatsache. Lernen braucht Anstrengung. Und hier ist der entscheidende Punkt: KI *kann* diese Anstrengung reduzieren, wenn sie passiv genutzt wird. Wer sich Antworten generieren lässt, statt selbst zu denken, umgeht die produktive Mühe.

Aber: Es ist nicht unvermeidlich. Erinnern Sie sich an den GPT-Tutor aus der Bastani-Studie? Dort wurde KI so eingesetzt, dass sie Fragen stellte und Hinweise gab, statt Antworten zu liefern. Das erhielt die kognitive Anstrengung. Die Art der Nutzung entscheidet.

Im Advanced-Kurs entwickeln Sie übrigens selbst ein solches pädagogisch gestaltetes KI-Tool.
