...
::: {.callout-note}
## Warum die Eisberg-Metapher?

**Die visuelle Botschaft:**

Der Eisberg macht sofort klar, worum es geht: Performance ist sichtbar (über Wasser), Learning ist unsichtbar (unter Wasser). Beide sind verbunden, aber nicht identisch.

Diese Metapher zieht sich durch den ganzen Vortrag:

- Die Bastani-Studie zeigt, wie Performance und Learning auseinanderfallen können
- Die Cognitive Load Theory erklärt, warum Learning unter der Oberfläche passiert
- Der Expertise-Umkehr-Effekt zeigt, dass dieselbe Intervention unterschiedlich wirkt

**Die Struktur des Vortrags:**

1. **Empirischer Einstieg** (Bastani-Studie): Konkret und überraschend
...
"Werkzeuge für Experten, Herausforderungen für Lernende" fasst die Kernthese zusammen: Dieselben KI-Werkzeuge wirken unterschiedlich, je nachdem wer sie nutzt.
:::
