...
# Teil 1: Was KI heute kann {background-color="#F0D4D4"}
...
## Diskussion {background-color="#F5E6C8"}
...
# Teil 2: Wie Expertise entsteht {background-color="#F0D4D4"}
...
**Newell & Simon** [@newellHumanProblemSolving1972] | **ACT-R** [@andersonAcquisitionCognitiveSkill1982]
...
**Forschungsüberblick** [@kalyugaExpertiseReversalEffect2009]
...
## Diskussion: Think-Pair-Share {background-color="#F5E6C8"}
...
# Teil 3: Kritisches Denken braucht Fachwissen {background-color="#F0D4D4"}
...
# Pause {background-color="#E5E4E2"}

::: {.timer #timer-4 seconds=900}
:::

# Teil 4: Das Produktivitäts-Lern-Paradox {background-color="#F0D4D4"}
...
4. **Retrieval Practice**: Abrufen statt Wiederlesen [@roedigerTestenhancedLearningTaking2006]
...
**Konzeptuelles Verständnis** [@lortie-forguesConceptualKnowledgeDecimal2017]
...
# Exkurs: "Sokratisches Fragen" in KI-Tutoren {background-color="#F0D4D4"}
...
# Teil 5: Implikationen und Synthese {background-color="#F0D4D4"}
...
## Offene Diskussion {background-color="#F5E6C8"}
