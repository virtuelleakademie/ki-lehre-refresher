...
{{< fa calculator size=3x >}}

**Taschenrechner**

[1970er]{style="color: #999;"}
...
{{< fa location-dot size=3x >}}

**GPS**

[1990er]{style="color: #999;"}
...
[{{< fa robot size=3x >}}]{style="color: #A3195B;"}

[**KI**]{style="color: #A3195B;"}

[2020er]{style="color: #999;"}

[Alles vorherige + mehr?]{style="color: #A3195B;"}

:::
:::

::: {style="text-align: center; margin-top: 1em;"}
[{{< fa circle size=xs >}}]{style="color: #666;"} ——— [{{< fa circle size=xs >}}]{style="color: #666;"} ——— [{{< fa circle size=xs >}}]{style="color: #666;"} ——— [{{< fa circle size=xs >}}]{style="color: #A3195B;"} {{< fa arrow-right >}}
:::
