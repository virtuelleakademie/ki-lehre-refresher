...
::: {.notes}
Drei Kurse, drei Fragen. Heute gehen wir durch alle drei. Zuerst kurz: Was kann KI? Dann der Kern: Wie funktioniert Lernen? Und zum Schluss: Wie gestalten wir Tools?
:::
...
::: {.notes}
Textvorhersage, Wort für Wort. Einfaches Prinzip, aber mächtiges Ergebnis. Drei Beispiele: Mathe-Tutorial, klinischer Bericht, Musterlösung. Entscheidend: Der Output liest sich wie Expertentext, egal ob er stimmt. → Überleitung: Warum ist das fürs Lernen relevant? Dazu brauchen wir die CLT.
:::
...
::: {.notes}
Oben: das Grundmodell. Information rein, Arbeitsgedächtnis verarbeitet, Schemata entstehen. Unten (Klick): drei Lastarten. Extrinsisch = schlechtes Design, reduzieren. Intrinsisch = Material + Vorwissen, steuern. Lernrelevant = die produktive Denkarbeit, maximieren. Ziel: extrinsische Last senken → mehr Kapazität für lernrelevante Verarbeitung.
:::
...
::: {.notes}
Interaktiv: Slider bewegen. Hohe extrinsische Last → kaum Platz für Lernen. Last senken → sofort Kapazität frei. Die blaue Fläche ist das, was zählt. KI kann Information liefern, aber die Verarbeitung muss im eigenen Kopf stattfinden.
:::
...
::: {.notes}
→ Überleitung: Wie überwindet man den Engpass? Durch Vorwissen, organisiert als Schemata. Grafik anklicken: isolierte Fakten → vernetzte Schemata. Ein Schema = viele Elemente als eine Einheit. Weniger Belastung fürs Arbeitsgedächtnis. Aber: Schemata aufbauen erfordert eigene Denkarbeit.
:::
...
::: {.notes}
→ Überleitung: Schemata helfen, aber auch das Aufgabendesign zählt. Erstes Prinzip: extrinsische Last reduzieren. Links: typische Quellen. Rechts: Gegenstrategien. Split-Attention ist das Paradebeispiel. Kernbotschaft: Jede Reduktion schafft Kapazität für lernrelevante Verarbeitung.
:::
...
::: {.notes}
→ Überleitung: Zweites Prinzip. Dieselbe Gleichung, aber völlig andere kognitive Kosten. Links: Anfänger, jedes Element einzeln. Rechts: Fortgeschrittene, drei automatisierte Schritte. Konsequenz: Ein Übungsblatt für alle ist für die meisten falsch.
:::
...
::: {.notes}
→ Überleitung: Wenn die Last zu hoch ist, braucht es Scaffolding. Drittes Prinzip. Links: Fading-Sequenz von Worked Example bis eigenständig. Rechts: konkretes Beispiel. Stufe 1 zeigt alles, Stufe 2 lässt eine Lücke. Die Unterstützung wird schrittweise abgebaut.
:::
...
::: {.notes}
→ Überleitung: Jetzt kommt KI ins Spiel. Links: Was ein Chatbot ohne Anleitung tut. Lösung ja, Scaffolding nein. Rechts: Was möglich ist, wenn man es richtig anlegt. Diagnose, angepasstes Scaffolding, Fading. Kernpunkt: Eine korrekte Lösung ist nicht automatisch ein gutes Worked Example.
:::
...
::: {.notes}
→ Konkretes Beispiel. Drei Teilkompetenzen, drei Karten. Klick: Tabelle zeigt die Logik. Beherrscht → Hinweis. Teilweise → Lücken. Nicht beherrscht → Worked Example. Das ist Fading, angepasst ans Vorwissen.
:::
...
::: {.notes}
Drei Erkenntnisse, je eine pro Lastart. 1: Extrinsisch reduzieren. 2: Intrinsisch ans Vorwissen anpassen. 3: Lernrelevante Verarbeitung fördern, nicht auslagern. → Überleitung zur Diskussion.
:::
...
::: {.notes}
Offene Diskussion. Vier Fragen als Einstieg, je nach Interesse eine auswählen. 1: Eigene Erfahrung mit KI-Nutzung. 2: Aufgabendesign, auch ohne KI. 3: Diagnostik, die CLT-Kernfrage. 4: Ausblick auf fachspezifische Tools.
:::
