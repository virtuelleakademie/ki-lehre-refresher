...
::: {.notes}
Textvorhersage, Wort für Wort. Einfaches Prinzip, aber mächtiges Ergebnis. 2 Beispiele: klinischer Bericht, Musterlösung. Entscheidend: Der Output liest sich wie Expertentext, egal ob er stimmt. → Überleitung: Warum ist das fürs Lernen relevant? Dazu brauchen wir die CLT.
:::
...
::: {.notes}
Oben: das Grundmodell. Information rein, Arbeitsgedächtnis verarbeitet, Schemata entstehen. Keine Technologie kann diesen Engpass umgehen.
Unten (Klick): drei Lastarten. Extrinsisch = schlechtes Design, reduzieren. Intrinsisch = Material + Vorwissen, steuern. Lernrelevant = die produktive Denkarbeit, maximieren. Ziel: extrinsische Last senken → mehr Kapazität für lernrelevante Verarbeitung.
:::
...
::: {.notes}
Interaktiv: Slider bewegen. Hohe extrinsische Last → kaum Platz für Lernen. Last senken → sofort Kapazität frei. Die blaue Fläche ist das, was zählt.
:::
...
::: {.notes}
→ Überleitung: Zweites Prinzip. Dieselbe Gleichung, aber völlig andere kognitive Kosten. 
Links: Anfänger: Jedes Element muss **einzeln** im Arbeitsgedächtnis gehalten werden. 

Rechts: Fortgeschrittene: Jeder Schritt ist eingeübt und läuft automatisch ab. Das Arbeitsgedächtnis wird kaum belastet.
:::
