...
Generative KI-Systeme wie ChatGPT, Claude und Gemini haben in kürzester Zeit beeindruckende Fähigkeiten demonstriert: Sie bestehen Anwaltsprüfungen, schreiben funktionierenden Code, diagnostizieren Krankheiten und verfassen wissenschaftliche Texte. Für viele Hochschullehrende stellt sich die Frage, wie diese Werkzeuge in die Lehre integriert werden können.

Doch die Forschung zeigt ein beunruhigendes Muster. In einer randomisierten kontrollierten Studie mit rund 1000 türkischen Gymnasiasten lösten Schüler mit GPT-4-Zugang 48% mehr Mathematikaufgaben korrekt. Als der KI-Zugang später entfernt wurde, schnitten dieselben Schüler 17% schlechter ab als die Kontrollgruppe, die nie KI hatte [@bastaniGenerativeAICan2024].

Diese Zahlen illustrieren das **Produktivitäts-Lern-Paradox**: KI verbessert die Aufgabenleistung, kann aber das Lernen beeinträchtigen. Die Frage ist nicht mehr *ob* KI hilft, sondern *wann* sie hilft und *wann* sie schadet.

Dieser Leitfaden bietet einen kognitionswissenschaftlich fundierten Rahmen, um diese Frage zu beantworten. Die zentrale These lautet:
...
Large Language Models (LLMs) wie GPT-4 oder Claude sind im Kern **Next-Word-Prediction-Systeme**. Sie wurden auf Milliarden von Textdokumenten trainiert und haben dabei Muster in Sprache, Argumentation und Stil gelernt. Eine hilfreiche Metapher: LLMs sind extrem ausgeklügelte Autovervollständigung.
...
Um zu verstehen, warum KI für Experten und Lernende unterschiedlich wirkt, müssen wir verstehen, wie Expertise überhaupt entsteht.

### Experten und Novizen sind grundlegend verschieden

Die kognitionspsychologische Forschung zeigt: Experten haben nicht einfach "mehr Wissen". Sie haben eine qualitativ andere **kognitive Architektur**.

Das klassische Beispiel stammt aus der Schachforschung (de Groot, 1965; Chase & Simon, 1973). Schachmeistern und Anfängern wurden Stellungen für wenige Sekunden gezeigt. Bei echten Spielstellungen erinnerten Meister etwa 25 Figuren korrekt, Anfänger nur etwa 4. Bei zufällig platzierten Figuren waren beide Gruppen gleich schlecht.
...
Die ACT-R-Theorie [@andersonAcquisitionCognitiveSkill1982] beschreibt, wie sich Problemlösestrategien mit wachsender Expertise verändern.
...
Die Cognitive Load Theory [@swellerCognitiveLoadTheory2024] ist eine der einflussreichsten Theorien der Instruktionspsychologie. Sie basiert auf zwei Gedächtnissystemen:

**Arbeitsgedächtnis:**

- Kapazität: 4±1 Elemente gleichzeitig
- Dauer: 15-30 Sekunden ohne Wiederholung
...
Eine verbreitete Annahme lautet: Wir müssen Studierenden beibringen, KI "kritisch zu nutzen". Das klingt vernünftig, greift aber zu kurz.
...
Daniel Willingham [@willinghamCriticalThinkingWhy2008], Professor für Kognitionspsychologie, fasst die Forschung provokant zusammen:
...
Wir kommen nun zum Kern der Argumentation: Warum KI die Aufgabenleistung verbessern, aber das Lernen beeinträchtigen kann.
...
Die eingangs erwähnte Studie [@bastaniGenerativeAICan2024] verdient genauere Betrachtung:
...
Eine Meta-Analyse über 86 Studien [@slameckaGenerationEffect1978] zeigt einen robusten Befund: Selbst generierte Information wird besser behalten als passiv erhaltene (**d = 0.40**).
...
Eine tiefere Frage betrifft die Entwicklung kognitiver Fähigkeiten. Wir unterscheiden:
...
**GPS und räumliches Gedächtnis** [@dahmaniHabitualUseGPS2020]: Eine longitudinale Studie über drei Jahre zeigte: Stärkere GPS-Nutzung korreliert mit steilerem Rückgang des räumlichen Gedächtnisses. Die Kausalität wurde bestätigt: GPS-Nutzung führt zum Rückgang, nicht umgekehrt.
...
Die bisherige Argumentation erklärt das unterschiedliche Muster:
...
- Blooms "Two Sigma Problem" (1984): 1:1-Tutoring erzielt 2 Standardabweichungen Verbesserung
...
**Aber:** Diese Effekte erfordern, dass Lernende genug Vorwissen haben, um sinnvolle Antworten zu generieren. Das verknüpft mit dem Expertise-Umkehr-Effekt: Was für Fortgeschrittene funktioniert, kann Novizen überfordern.
...
Der Effekt kam primär von Schritt-für-Schritt-Feedback und gezielten Hinweisen, **nicht** vom sokratischen Dialog an sich.
...
Die zentrale These lässt sich nun präzisieren:
...
- Der präfrontale Kortex entwickelt sich bis Mitte 20
- Exekutive Funktionen, Metakognition, Selbstregulation sind bei Studierenden noch in Entwicklung
...
Dieser Leitfaden hat argumentiert, dass KI-Werkzeuge für Experten konzipiert sind und Experten produktiver machen, während Lernende oft nicht profitieren, weil Lernen die kognitive Anstrengung erfordert, die KI eliminiert.
...
Die offenen Fragen sind zahlreich. Langzeitstudien fehlen, optimale Strategien sind unbekannt, und die Effekte sind wahrscheinlich kontext- und personenspezifisch.

Was bleibt, ist eine Haltung: **Informierte Vorsicht bei Handlungsfähigkeit.** Weder Panik noch unkritische Übernahme. Evidenz ernst nehmen, auch wenn sie unvollständig ist. Die Verantwortung für Bildungsentscheidungen nicht an Technologietrends delegieren.

Die Frage ist letztlich nicht, ob KI in die Bildung kommt. Sie ist schon da. Die Frage ist, wie wir sie so gestalten, dass sie dem Lernen dient, nicht es ersetzt.
