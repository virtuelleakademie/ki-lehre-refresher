...
Die Antwort ist komplizierter, als viele annehmen. Eine Studie in *Management Science* [@bastaniGenerativeAIGuardrails2025] zeigt ein beunruhigendes Muster: Rund 1000 Gymnasiasten mit GPT-4-Zugang lösten 48% mehr Mathematikaufgaben korrekt. Als der KI-Zugang später entfernt wurde, schnitten dieselben Schüler jedoch 17% *schlechter* ab als jene, die nie KI hatten.
...
- **KI-generierte Antworten** sind Outputs auf Anfrage, nicht didaktisch sequenziert, nicht auf den individuellen Lernstand abgestimmt

Der Unterschied ist *Intentionalität*: Worked Examples sind Teil eines durchdachten Instruktionsdesigns. KI-Antworten sind reaktiv und unsystematisch.
...
**Was wir wissen (Evidenz):** Fertigkeitsatrophie ist gut dokumentiert. Eine vorhandene Fähigkeit verkümmert durch Nichtgebrauch. Das ist reversibel: Wenn man wieder übt, kommt die Fähigkeit zurück. Der Generierungseffekt und die Prinzipien erwünschter Schwierigkeiten sind empirisch belegt.
...
**Taschenrechner** [@lortie-forguesConceptualKnowledgeDecimal2017]: Die Forschung zeigt kontextabhängige Effekte. Für Schüler mit bestehenden Grundkenntnissen ist der Effekt neutral oder leicht positiv. Für Schüler ohne Grundkenntnisse ist der Effekt negativ. Dieselbe Parallele wie bei KI: Das Werkzeug wirkt unterschiedlich je nach Vorwissen.
...
Eine praktische Unterscheidung hilft bei der Bewertung von KI-Nutzung:
...
Dieser Leitfaden fokussiert auf kognitive Prozesse: Arbeitsgedächtnis, Schemabildung, Abrufübung. Aber Lernen ist nicht nur ein individueller kognitiver Prozess. Es ist fundamental sozial [@reichFailureDisruptWhy2020].
...
Diese Dimension verdient mehr Aufmerksamkeit, als dieser Leitfaden ihr geben kann. Der Fokus auf Kognition ist eine bewusste Einschränkung, keine Aussage über relative Wichtigkeit.
...
- **Kosten:** Premium-KI-Werkzeuge kosten Geld. Wer kann sich GPT-4, Claude Pro oder spezialisierte Tools leisten? Wer ist auf kostenlose, limitierte Versionen angewiesen?
...
**Realitätscheck:** Individuelle Entscheidungen finden in Systemen statt. Institutionelle Vorgaben, Studierendenerwartungen und Arbeitsmarktanforderungen setzen Grenzen. Perfekte Umsetzung ist selten möglich. Was zählt, ist informiertes Handeln im eigenen Spielraum.
:::
